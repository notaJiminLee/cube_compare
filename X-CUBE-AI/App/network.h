...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "download"
...
#define AI_NETWORK_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_S8, 32, 32, 3, 1, NULL), \
}
...
#define AI_NETWORK_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 100, 1, NULL), \
}
...
#define AI_NETWORK_OUT_1_SIZE        (1 * 1 * 100)
#define AI_NETWORK_OUT_1_SIZE_BYTES  (AI_NETWORK_OUT_1_SIZE * 4)

/******************************************************************************/
#define AI_NETWORK_N_NODES (44)
